...
xst -ifn xst.scr
move fake_tart_clk_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\fake_tart_clk_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc fake_tart_clk_exdes.ucf fake_tart_clk_exdes

echo 'Running map'
map -timing -pr b fake_tart_clk_exdes -o mapped.ncd
...
netgen -ofmt verilog -sim -sdf_anno false -tm fake_tart_clk_exdes -w routed.ncd routed.v
cd ..
