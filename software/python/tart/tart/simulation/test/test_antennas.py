...
def get_src(el, az):
    return HorizontalSource(r=1e9, azimuth=angle.from_dms(az), elevation=angle.from_dms(el))
...
class TestAntenna(unittest.TestCase):
    ...
    def test_60(self):
        ...
        self.assertAlmostEqual(a0.get_geo_delay_horizontal(src), 0.0)
        self.assertAlmostEqual(a1.get_geo_delay_horizontal(src)*constants.V_LIGHT, -0.5, places=4) # a1 is closer to origin so negative
        self.assertAlmostEqual(get_geo_delay_horizontal(a0, a1, src)*constants.V_LIGHT, -0.5, places=4) # t_a1 - t_a0 negative
        self.assertAlmostEqual(get_geo_delay_horizontal(a1, a0, src)*constants.V_LIGHT, 0.5, places=4)
    ...
    def test_symmetry(self):
        ...
        src = get_src(60,180)
        self.assertAlmostEqual(a0.get_geo_delay_horizontal(src), 0.0)
        self.assertAlmostEqual(a1.get_geo_delay_horizontal(src)*constants.V_LIGHT, 0.5, places=4) # a1 is further away, so positive
