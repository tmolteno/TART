...
def telescope_signals(ref_freq, freq_mult, sample_duration, baseline, angle_1, angle_2):
  ...
  s1 = source_1[:n] #+ source_2[:n] + noise_1 # Un-delayed signal with instrument noise
  s2 = source_1[sample_delay_1:n+sample_delay_1] #+ source_2[sample_delay_2:n+sample_delay_2]+ noise_2 # Delayed signal with instrument noise
...
if __name__ == '__main__':
  ...
  telescope_signals(ref_freq, freq_mult, sample_duration, ref_div, main_div, bandwidth, order, baseline, angle_1, angle_2)